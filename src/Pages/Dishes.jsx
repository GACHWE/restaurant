...
const Dishes = () => {
    return (
        <section id='dishes' 
        className='min-h-screen flex flex-col justify-center items-center lg:px-32 px-5  text-gray-200 p-5 md:px-32  duration-200'>
            <Motion.div variants={containerVariants} initial="hidden" whileInView={"visible"} viewport={{ amount: 0.8 }}>
                <Motion.div variants={cardVariants}>
                    <h1 className='text-4xl font-semibold text-center  pb-10'>Our Dishes</h1>
